...
public class PunchAndGrab2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        forearmsBody[0].solverIterations = 255;
        forearmsBody[1].solverIterations = 255;
    }
                ...
                if (Input.GetButton("Jump")) //(rightGrabCheck.hasJoint)
                {
                    ...
                    else
                    {
                        ...
                        if (leftGrabTimer < climbGrabSpeed * 0.6f)
                        {
                            ...
                            armsJoint[0].targetAngularVelocity = jointValue;
                            //armsJoint[0].targetRotation = new Quaternion(1, 0, 0, 1);
                        ...
                        if (leftGrabTimer >= climbGrabSpeed * 0.6f && leftGrabTimer < climbGrabSpeed * 1f)
                        {
                            ...
                            Vector3 jointValue = new Vector3(-20f, 20f, 20f);
                            //armsJoint[0].targetRotation = new Quaternion(-0, 1, 0, 1);
                            armsJoint[0].targetAngularVelocity = jointValue;
                ...
                if (Input.GetButton("Jump")) //(rightGrabCheck.hasJoint)
                {
                    ...
                    else
                    {
                        ...
                        if (rightGrabTimer < climbGrabSpeed * 0.6f)
                        {
                            ...
                            armsJoint[1].targetAngularVelocity = jointValue;
                            //armsJoint[1].targetRotation = new Quaternion(-1, 0, 0, 1);
                        ...
                        if (rightGrabTimer >= climbGrabSpeed * 0.6f && rightGrabTimer < climbGrabSpeed * 1f)
                        {
                            ...
                            Vector3 jointValue = new Vector3(20f, -20f, 20f);
                            //armsJoint[1].targetRotation = new Quaternion(0, -1, 0, 1);
                            armsJoint[1].targetAngularVelocity = jointValue;
